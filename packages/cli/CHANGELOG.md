...
- 098e3f2: Add `openislands infer <file>` — infer a data file's schema, propose a canonical dataset contract with suggested islands, and `--bind` it into the manifest. `openislands add` now scaffolds every built-in island type.
...
- Updated dependencies [60d167c]
- Updated dependencies [4f48872]
  - @openislands/compiler@0.2.0
  - @openislands/schema@0.2.0
  - @openislands/runtime@0.2.0
