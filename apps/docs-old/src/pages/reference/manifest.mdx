...
**Span:** min 2, recommended 4, max 6 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 3, recommended 6, max 12 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 4, recommended 8, max 12 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 3, recommended 4, max 6 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 4, recommended 6, max 8 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 5, recommended 8, max 12 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 3, recommended 4, max 8 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 4, recommended 7, max 12 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 4, recommended 5, max 8 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 2, recommended 5, max 8 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
...
**Span:** min 2, recommended 4, max 12 (of 12). Omit `span` to render at the recommended width; below min or above max is a named error.
