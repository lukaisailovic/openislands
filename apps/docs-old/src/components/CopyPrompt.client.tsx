...
/**
 * A single hero button that copies an agent-ready prompt to the clipboard. It
 * mirrors the neighbouring Vocs HomePage buttons and swaps to a checkmark and
 * "Copied" for a moment so a reader knows the click landed.
 */
