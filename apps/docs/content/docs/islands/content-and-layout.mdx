...
a busy page. See the [islands overview](/islands/overview) for the full registry.
...
See [Pages and groups](/concepts/manifest#pages-and-groups) for the page-level shape and the
`islands`/`groups` rule.
