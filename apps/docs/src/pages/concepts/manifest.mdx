...
That check is the safety net the whole design rests on. Keep the manifest declarative — no
data transforms inside island configs; shaping lives in the [data layer](/concepts/data-contracts) —
and the net stays taut.

## Where to go next

- [Data Contracts](/concepts/data-contracts) — datasets, SQL transforms, and the binding
  check in detail.
